#!/bin/bash
# Script to patch reviewer.py with review submission endpoints

# Append the endpoints to the end of reviewer.py
cat >> /Users/shivyanshusaini/Desktop/AACS/backend/app/api/v1/reviewer.py << 'EOF'
...
echo "✓ Review submission endpoints added to reviewer.py"
